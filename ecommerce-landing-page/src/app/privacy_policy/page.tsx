...
const CombinedInfoPage = () => {
    return (
        <main className="max-w-4xl mx-auto px-4 py-10">
            ...
            */}
            <section className="mb-16 p-6 bg-white shadow-lg rounded-lg">
                <h2 className="text-3xl font-bold mb-4 text-center text-indigo-700">Privacy Policy</h2>
                <p className="text-sm text-gray-500 mb-6 text-center">Last updated: May 21, 2025</p>
                ...
                <div className="space-y-6">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800">3. Cookies and Tracking Technologies</h3>
                    ...
                    <h3 className="text-xl font-semibold text-gray-800">4. Third-Party Tools and Services</h3>
                    <p className="text-gray-700">
                    ...
                    <p className="text-gray-700">We are not responsible for the privacy practices or content of these third-party websites or services.</p>
                    ...
                    <p className="text-gray-700">Depending on your jurisdiction and applicable data protection laws, you may have the following rights regarding your personal information:</p>
                    <ul className="list-disc list-inside ml-4 space-y-2 text-gray-700">
                        <li>
                    ...
                    <h3 className="text-xl font-semibold text-gray-800">7. Updates to This Privacy Policy</h3>
                    <p className="text-gray-700">
            ...
            <section className="p-6 bg-white shadow-lg rounded-lg">
                ...
                <section className="mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Portfolio Websites</h4>
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Business Landing Pages</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">E-commerce Solutions</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Admin Dashboard Integration</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Blog &amp; Content Management Systems (CMS)</h4>
                            <p className="text-gray-600">
                ...
                <section className="mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Search Engine Optimization (SEO)</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Google Ads / PPC Campaigns</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Email Marketing</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Lead Generation Campaigns</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Conversion Optimization</h4>
                            <p className="text-gray-600">
                ...
                <section className="mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Monthly Content Planning</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Caption Writing &amp; Hashtag Research</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Reels &amp; Video Edits for Instagram, YouTube Shorts, TikTok</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Scheduling &amp; Posting</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Engagement Boosting Strategies</h4>
                            <p className="text-gray-600">
                ...
                <section className="mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Commercial Video Editing</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">YouTube &amp; Short Form Edits</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Cinematic Edits</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">VFX Shots (Green Screen, CGI Integration, Clean-ups)</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Motion Graphics &amp; Titles</h4>
                            <p className="text-gray-600">
                ...
                <section className="mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Blog Writing</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Product Copywriting</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Visual Content for Social Media</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Scriptwriting for Ads or YouTube</h4>
                            <p className="text-gray-600">
                        ...
                        <div>
                            <h4 className="text-xl font-medium mb-2 text-gray-800">Photography &amp; Thumbnail Design</h4>
                            <p className="text-gray-600">
