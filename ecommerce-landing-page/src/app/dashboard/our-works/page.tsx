    ...
    const handleSelect = (id: number) => {
        ...
        if (selected) {
            ...
            setForm({
                ...
                type: selected.type,
                category: selected.category || 'web-design',
        ...
        <main className="min-h-screen bg-white dark:bg-gray-950 text-black dark:text-white px-6 py-8 transition-colors">
            <div className="ml-[100px] max-w-6xl mx-auto">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Manage Our Works</h1>
                        <p className="text-gray-600 dark:text-gray-400">Total Works: {works.length}</p>
                    </div>
                    <Link href="/dashboard">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md overflow-hidden mb-8">
                    <div className="overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            {works.map(work => (
                                <tr key={work.id} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">
                                        {work.title}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                                        {CATEGORIES.find(cat => cat.value === work.category)?.label || work.category}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    placeholder="/our-works/project-name"
                                    value={form.route}
            ...
            {showDeleteConfirm && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl p-6 w-full max-w-md">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-6">Are you sure you want to delete this work? This action cannot be undone.</p>
