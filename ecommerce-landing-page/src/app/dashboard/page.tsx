        ...
        <main className="min-h-screen bg-white dark:bg-black text-black dark:text-white px-6 py-20 transition-colors">
            <div className="max-w-7xl mx-auto relative ml-0 md:ml-[100px] transition-all">
                ...
                <p className="text-lg leading-relaxed mb-10">
                    This dashboard allows you to edit and manage the content of your portfolio site. You’ll be able to
                    add, edit, or
                ...
                <div className="space-y-8">
                    <div className="space-y-4">
                        <Link href="/dashboard/our-works">
                            <button
                                className="w-full text-left p-6 bg-gray-100 dark:bg-gray-800 rounded shadow hover:bg-gray-200 dark:hover:bg-gray-700 transition">
                        ...
                        <Link href="/dashboard/contact">
                            <button
                                ...
                                <p>Control and update contact</p>
                            </button>
                        </Link>
