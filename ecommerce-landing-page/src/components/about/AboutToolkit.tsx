...
export default function AboutToolkit() {
    return (
        <motion.section
            ...
            className="space-y-6"
        >
            <motion.h2 variants={itemVariants} className="text-3xl font-bold text-blue-800 dark:text-blue-200 mb-4">My Toolkit</motion.h2>
            ...
            <motion.p variants={itemVariants} className="text-sm text-gray-600 dark:text-gray-400 mt-4 text-center italic">
